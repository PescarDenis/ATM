...
HD_PWD='C:/Users/pesca/Desktop/projects vivado/State_coding/State_coding.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log State_coding.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source State_coding.tcl
