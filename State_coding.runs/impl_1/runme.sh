...
HD_PWD='C:/Users/pesca/Desktop/projects vivado/State_coding/State_coding.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log State_coding.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source State_coding.tcl -notrace
